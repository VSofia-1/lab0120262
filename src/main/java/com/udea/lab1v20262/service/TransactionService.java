...
import com.udea.lab1v20262.repository.TransactionRepository;
...
//    .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Sender not found"));
    ...
    public TransactionDTO updateTransaction(Long id, TransactionDTO transactionDTO) {
        ...
        existing.setSenderAccountNumber(transactionDTO.getSenderAccountNumber());
        existing.setReceiverAccountNumber(transactionDTO.getReceiverAccountNumber());
        existing.setAmount(transactionDTO.getAmount());
        Transaction saved = transactionRepository.save(existing);

        TransactionDTO dto = new TransactionDTO();
        dto.setId(saved.getId());
        dto.setSenderAccountNumber(saved.getSenderAccountNumber());
        dto.setReceiverAccountNumber(saved.getReceiverAccountNumber());
